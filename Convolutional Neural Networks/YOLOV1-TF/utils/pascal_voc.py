...
class pascal_voc(object):
    def __init__(self, phase, rebuild=False):
        ...
        self.cell_size = cfg.CELL_SIZE                #CELL_SIZE = 19
        self.classes = cfg.CLASSES                    #['qr']
        self.class_to_ind = dict(zip(self.classes, range(len(self.classes))))  #{'qr':0}
    ...
    def get(self):
        ...
        labels = np.zeros((self.batch_size, self.cell_size, self.cell_size, 6))
        count = 0
    ...
    def load_labels(self):
        ...
        # cache_path=/data/pascal_voc/cache
