...
# 数据参数
MODEL_DIR = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\Result'  # inception-v3模型的文件夹
MODEL_FILE = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\DataSet\tensorflow_inception_graph.pb'  # inception-v3模型文件名
CACHE_DIR = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\Result'  # 图像的特征向量保存地址
INPUT_DATA = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\DataSet'  # 图片数据文件夹
