...
# 处理好之后的数据文件。
INPUT_DATA = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\DataSet\flower_processed_data.npy'
# 保存训练好的模型的路径。
TRAIN_FILE = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3'
# 谷歌提供的训练好的模型文件地址。因为GitHub无法保存大于100M的文件，所以
# 在运行时需要先自行从Google下载inception_v3.ckpt文件。
CKPT_FILE = r'E:\Code\DeepLearning\Algorithm\NeuralNetwork\Transfer Learning\Inception_v3\DataSet\inception_v3.ckpt'
